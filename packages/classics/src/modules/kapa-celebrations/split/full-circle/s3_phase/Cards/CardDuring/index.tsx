...
export function CardDuringCover() {
    return (
        <Paper
            radius="xl"
            shadow="xl"
            h={650}
            bg="linear-gradient(150deg,#EE7D32,#350F0F)"
            p="3rem"
        >
            <Group justify="space-between">
                <Group gap="xs" opacity={.5}>
                    <Text size="10px" c="gray.0">
                        PREPARATION<br />PRE<br /> EVENT
                    </Text>

                    <Text size="10px" c="gray.0">
                        THE WORK<br />BEHIND<br /> THE SCENES
                    </Text>
                </Group>
            ...
            >
                <Text size="md" lh="100%" c="gray.0">
                    THE WORK<br />DURING THE<br /> CELEBRATION
                </Text>
            </Group>
