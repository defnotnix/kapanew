...
export function CardPreCover() {
  return (
    <Paper radius="xl" shadow="xl" h={650} bg="var(--kc-color-800)" p="3rem">
      ...
      <Center mt={90} mb={30} pos="relative">
        ...
        <Image
          ...
          w={190}
          h={280}
          src="https://images.unsplash.com/photo-1671726203390-48b983895c0e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        />
